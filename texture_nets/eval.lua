...
cmd:option('-weights', '../lamem/memnet/part_2_snapshots/_iter_70000.caffemodel', 'Weights of the network .caffemodel')
cmd:option('-network', '../lamem/memnet/deploy.prototxt',  'Network description')
